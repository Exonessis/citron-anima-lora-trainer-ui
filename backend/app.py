...
def create_training_config(
    ...
    # pytorch_optimizer schedulers cannot be passed as lr_scheduler (HF SchedulerType enum
    # only accepts its own built-in names). Use lr_scheduler_type instead, which sd-scripts
    # routes through a custom dotted-path loader, and fall back lr_scheduler to "constant".
    if lr_scheduler.startswith("pytorch_optimizer."):
        effective_lr_scheduler = "constant"
        lr_scheduler_type = lr_scheduler
    else:
        effective_lr_scheduler = lr_scheduler
        lr_scheduler_type = ""
    ...
    training_config = {
        ...
        "lr_scheduler": effective_lr_scheduler,
